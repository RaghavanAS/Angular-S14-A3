...
export class CustomerComponentComponent implements OnInit {
  ...
  // get the customer by his id by caling the customer service
  ngOnInit() {
   ...
   // get the city list by caling the city service
  ...
  // get the customer list by calling the customer service
  ...
  // handle the unsaved changes using the candeactivate gaurd
